...
void get_cfg_dat_Project_TD_2430_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(l_partkey#1L, l_extendedprice#5, l_discount#6)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(l_partkey#49, l_extendedprice#117, l_discount#134)
    // Node Depth: 2
    ap_uint<512>* b = hbuf;
    ...
    shuffle3_cfg(31, 24) = 8; // l_partkey
