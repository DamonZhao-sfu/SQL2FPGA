...
void get_cfg_dat_Project_TD_5464_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(s_suppkey#484L)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(s_suppkey#498)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_INNER_TD_2848_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Operation: ListBuffer((p_partkey#420 = ps_partkey#460))
        // Binded Operation: Project -> operations: ListBuffer(cast(ps_partkey#450L as int) AS ps_partkey#460, cast(ps_suppkey#451L as int) AS ps_suppkey#466)
        // Binded Operation: Project -> operations: ListBuffer(cast(p_partkey#402L as int) AS p_partkey#420)
    // Left Table: ListBuffer(p_partkey#402L, p_type#405, p_size#406, p_brand#410)
    ...
    shuffle2_cfg(15, 8) = 1; // p_type
    shuffle2_cfg(23, 16) = 2; // p_size
