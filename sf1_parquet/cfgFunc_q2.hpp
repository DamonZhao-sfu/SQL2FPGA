...
void get_cfg_dat_JOIN_INNER_TD_5632_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(ps_partkey#450L, ps_suppkey#451L, ps_supplycost#453)
    // Right Table: ListBuffer(p_partkey#402L, p_mfgr#404)
...
void get_cfg_dat_Project_TD_4188_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(s_suppkey#484L, s_name#485, s_address#486, s_nationkey#487L, s_phone#488, s_acctbal#489, s_comment#490)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(s_suppkey#498, s_name#485, s_address#486, s_nationkey#506, s_phone#488, s_acctbal#514, s_comment#490)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 8; // s_suppkey
    shuffle3_cfg(15, 8) = 1; // s_name
    shuffle3_cfg(23, 16) = 2; // s_address
    shuffle3_cfg(31, 24) = 3; // s_phone
    shuffle3_cfg(39, 32) = 4; // s_comment
    shuffle3_cfg(47, 40) = 8; // s_suppkey
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 5; // s_suppkey
    shuffle4_cfg(15, 8) = 1; // s_name
    shuffle4_cfg(23, 16) = 2; // s_address
    shuffle4_cfg(31, 24) = 1; // s_nationkey
    shuffle4_cfg(39, 32) = 3; // s_phone
    shuffle4_cfg(47, 40) = 2; // s_acctbal
    shuffle4_cfg(55, 48) = 4; // s_comment
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_Project_TD_3551_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(n_nationkey#296L, n_name#297, n_regionkey#298L)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(n_nationkey#304, n_name#297, n_regionkey#309)
    // Node Depth: 3
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    ap_uint<289> op_eval_0 = 0; // n_nationkey#296L
    xf::database::dynamicALUOPCompiler<uint32_t, uint32_t, uint32_t, uint32_t>("strm1", 0, 0, 0, 0, op_eval_0);
    b[1] = op_eval_0;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // n_regionkey
    shuffle3_cfg(15, 8) = 8; // n_nationkey
    shuffle3_cfg(23, 16) = 8; // n_nationkey
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    ap_uint<289> op_eval_1 = 0; // n_regionkey#298L
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // n_nationkey
    shuffle4_cfg(15, 8) = 1; // n_name
    shuffle4_cfg(23, 16) = 8; // n_regionkey
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
