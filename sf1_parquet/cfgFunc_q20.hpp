...
void get_cfg_dat_Aggregate_TD_7176_gqe_aggr(ap_uint<32>* buf) {
    ...
    // Input Table: ListBuffer(l_partkey#49, l_suppkey#66, l_quantity#100)
    ...
    ap_uint<289> op_eval_0 = 0; // (0.5 * l_quantity#100)
    ...
    shuffle1_cfg(15, 8) = 1; // l_suppkey#66
    ...
    shuffle3_cfg(7, 0) = 2; // l_partkey#49
    shuffle3_cfg(15, 8) = 1; // l_suppkey#66
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_6942_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    ...
    // Right Table: ListBuffer(ps_partkey#450L, ps_suppkey#451L, ps_availqty#452)
...
void get_cfg_dat_JOIN_INNER_TD_511_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_3114_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((cast(s_suppkey#484L as int) = ps_suppkey#466))
    // Left Table: ListBuffer(ps_suppkey#466)
    // Right Table: ListBuffer(s_suppkey#484L, s_name#485, s_address#486, s_nationkey#487L)
...
void get_cfg_dat_JOIN_INNER_TD_1993_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((s_nationkey#506 = n_nationkey#304))
    // Left Table: ListBuffer(s_name#485, s_address#486, s_nationkey#506)
    // Right Table: ListBuffer(n_nationkey#304)
    // Output Table: ListBuffer(s_name#485, s_address#486)
    // Node Depth: 1
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
