...
void get_cfg_dat_Project_TD_6623_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle3_cfg(7, 0) = 8; // c_acctbal
    shuffle3_cfg(15, 8) = 8; // c_acctbal
...
void get_cfg_dat_Project_TD_498_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(o_custkey#325L)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(o_custkey#352)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    ap_uint<289> op_eval_0 = 0; // o_custkey#325L
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 8; // o_custkey
    shuffle3_cfg(15, 8) = 8; // o_custkey
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
