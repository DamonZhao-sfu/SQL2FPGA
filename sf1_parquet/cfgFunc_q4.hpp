...
void get_cfg_dat_Project_TD_3545_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(l_orderkey#0L)
    // Right Table: ListBuffer()
    // Output Table: ListBuffer(l_orderkey#32)
    // Node Depth: 3
    ap_uint<512>* b = hbuf;
    ...
    ap_uint<289> op_eval_0 = 0; // l_orderkey#0L
    ...
    shuffle3_cfg(7, 0) = 8; // l_orderkey
    shuffle3_cfg(15, 8) = 8; // l_orderkey
