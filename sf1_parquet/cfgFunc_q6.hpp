...
void get_cfg_dat_Project_TD_1432_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Left Table: ListBuffer(l_extendedprice#5, l_discount#6)
    ...
    ap_uint<289> op_eval_0 = 0; // (l_extendedprice#5 * 100.00)
    ...
    shuffle3_cfg(7, 0) = 1; // l_discount
    shuffle3_cfg(15, 8) = 8; // l_extendedprice
    shuffle3_cfg(23, 16) = 8; // l_extendedprice
    ...
    ap_uint<289> op_eval_1 = 0; // (l_discount#6 * 100.00)
    ...
    shuffle4_cfg(7, 0) = 2; // l_extendedprice
    shuffle4_cfg(15, 8) = 8; // l_discount
