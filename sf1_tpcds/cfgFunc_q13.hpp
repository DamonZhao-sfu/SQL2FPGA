...
void get_cfg_dat_JOIN_INNER_TD_3463999_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // ss_cdemo_sk
    shuffle2_cfg(15, 8) = 9; // ss_hdemo_sk
    shuffle2_cfg(23, 16) = 10; // ss_quantity
    shuffle2_cfg(31, 24) = 11; // ss_sales_price
    shuffle2_cfg(39, 32) = 6; // ss_ext_sales_price
    shuffle2_cfg(47, 40) = 8; // ss_ext_wholesale_cost
    ...
    shuffle3_cfg(7, 0) = 0; // ss_cdemo_sk
    ...
    shuffle3_cfg(47, 40) = 5; // ss_ext_wholesale_cost
    ...
    shuffle4_cfg(7, 0) = 0; // ss_cdemo_sk
    ...
    shuffle4_cfg(47, 40) = 5; // ss_ext_wholesale_cost
