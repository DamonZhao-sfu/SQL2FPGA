...
void get_cfg_dat_JOIN_INNER_TD_4491364_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 12; // d_week_seq
    shuffle2_cfg(15, 8) = 10; // sun_sales
    shuffle2_cfg(23, 16) = 8; // mon_sales
    shuffle2_cfg(31, 24) = 12; // tue_sales
    shuffle2_cfg(39, 32) = 7; // wed_sales
    shuffle2_cfg(47, 40) = 9; // thu_sales
    shuffle2_cfg(55, 48) = 11; // fri_sales
    shuffle2_cfg(63, 56) = 6; // sat_sales
    ...
    shuffle3_cfg(7, 0) = 0; // d_week_seq
    shuffle3_cfg(15, 8) = 1; // sun_sales
    shuffle3_cfg(23, 16) = 2; // mon_sales
    shuffle3_cfg(31, 24) = 3; // tue_sales
    shuffle3_cfg(39, 32) = 4; // wed_sales
    shuffle3_cfg(47, 40) = 5; // thu_sales
    shuffle3_cfg(55, 48) = 6; // fri_sales
    shuffle3_cfg(63, 56) = 7; // sat_sales
    ...
    shuffle4_cfg(7, 0) = 0; // d_week_seq
    shuffle4_cfg(15, 8) = 1; // sun_sales
    shuffle4_cfg(23, 16) = 2; // mon_sales
    shuffle4_cfg(31, 24) = 3; // tue_sales
    shuffle4_cfg(39, 32) = 4; // wed_sales
    shuffle4_cfg(47, 40) = 5; // thu_sales
    shuffle4_cfg(55, 48) = 6; // fri_sales
    shuffle4_cfg(63, 56) = 7; // sat_sales
