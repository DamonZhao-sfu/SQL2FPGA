...
void get_cfg_dat_JOIN_INNER_TD_7128871_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(23, 16) = 11; // cs_promo_sk
    shuffle2_cfg(31, 24) = 8; // cs_quantity
    shuffle2_cfg(39, 32) = 12; // cs_list_price
    shuffle2_cfg(47, 40) = 9; // cs_sales_price
    shuffle2_cfg(55, 48) = 10; // cs_coupon_amt
    ...
    shuffle3_cfg(39, 32) = 4; // cs_list_price
    shuffle3_cfg(47, 40) = 5; // cs_sales_price
    shuffle3_cfg(55, 48) = 6; // cs_coupon_amt
    ...
    shuffle4_cfg(39, 32) = 4; // cs_list_price
    shuffle4_cfg(47, 40) = 5; // cs_sales_price
    shuffle4_cfg(55, 48) = 6; // cs_coupon_amt
...
void get_cfg_dat_JOIN_INNER_TD_6466058_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 10; // cs_promo_sk
    shuffle2_cfg(23, 16) = 7; // cs_quantity
    shuffle2_cfg(31, 24) = 11; // cs_list_price
    shuffle2_cfg(39, 32) = 8; // cs_sales_price
    shuffle2_cfg(47, 40) = 9; // cs_coupon_amt
