...
void get_cfg_dat_JOIN_INNER_TD_3163955_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 6; // d_year
    shuffle2_cfg(15, 8) = 1; // ss_item_sk
    shuffle2_cfg(23, 16) = 0; // ss_ext_sales_price
