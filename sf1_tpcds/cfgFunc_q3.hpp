...
void get_cfg_dat_JOIN_INNER_TD_3104616_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_2789433_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_Aggregate_TD_1758145_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_orderkey#50, o_orderdate#231, o_shippriority#234, sum((l_extendedprice#55 * (100 - l_discount#56))) AS revenue#953L)
    // Input Table: ListBuffer(o_orderdate#231, o_shippriority#234, l_orderkey#50, l_extendedprice#55, l_discount#56)
    // Output Table: ListBuffer(l_orderkey#50, revenue#953L, o_orderdate#231, o_shippriority#234)
    // Node Depth: 1
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 5; // revenue#953L
    shuffle4_cfg(15, 8) = -1;
