...
void get_cfg_dat_Aggregate_TD_10418601_gqe_aggr(ap_uint<32>* buf) {
...
void get_cfg_dat_Aggregate_TD_10169659_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
...
void get_cfg_dat_JOIN_INNER_TD_6478433_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
