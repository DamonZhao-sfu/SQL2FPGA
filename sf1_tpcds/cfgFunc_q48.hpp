...
void get_cfg_dat_JOIN_INNER_TD_4880627_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 6; // ss_cdemo_sk
    shuffle2_cfg(23, 16) = 8; // ss_addr_sk
    shuffle2_cfg(31, 24) = 10; // ss_quantity
    ...
    shuffle3_cfg(15, 8) = 1; // ss_cdemo_sk
    ...
    shuffle4_cfg(15, 8) = 1; // ss_cdemo_sk
...
void get_cfg_dat_JOIN_INNER_TD_1178130_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
