...
void get_cfg_dat_JOIN_INNER_TD_8235489_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_7714058_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_6716045_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_Aggregate_TD_5443923_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manufact_id#241, d_qoy#130, MakeDecimal(sum(UnscaledValue(ss_sales_price#1219)),17,2) AS sum_sales#3609, MakeDecimal(sum(UnscaledValue(ss_sales_price#1219)),17,2) AS _w0#3614)
    // Input Table: ListBuffer(i_manufact_id#241, ss_sales_price#1219, d_qoy#130)
    // Output Table: ListBuffer(i_manufact_id#241, sum_sales#3609, _w0#3614)
    // Node Depth: 5
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 3; // sum_sales#3609
    shuffle4_cfg(15, 8) = 8; // _w0#3614
