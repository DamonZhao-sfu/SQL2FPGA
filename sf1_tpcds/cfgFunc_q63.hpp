...
void get_cfg_dat_JOIN_INNER_TD_8112617_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_7786548_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_6602153_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_Aggregate_TD_549036_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manager_id#248, d_moy#128, MakeDecimal(sum(UnscaledValue(ss_sales_price#1219)),17,2) AS sum_sales#3665, MakeDecimal(sum(UnscaledValue(ss_sales_price#1219)),17,2) AS _w0#3670)
    // Input Table: ListBuffer(i_manager_id#248, ss_sales_price#1219, d_moy#128)
    // Output Table: ListBuffer(i_manager_id#248, sum_sales#3665, _w0#3670)
    // Node Depth: 5
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 3; // sum_sales#3665
    shuffle4_cfg(15, 8) = 8; // _w0#3670
