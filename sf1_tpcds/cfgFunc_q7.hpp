...
void get_cfg_dat_JOIN_INNER_TD_6838353_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle3_cfg(15, 8) = 1; // ss_promo_sk
    ...
    shuffle4_cfg(15, 8) = 1; // ss_promo_sk
