...
void get_cfg_dat_JOIN_INNER_TD_6963972_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // ss_ext_sales_price
    shuffle2_cfg(15, 8) = 8; // ss_item_sk
    shuffle2_cfg(23, 16) = 6; // ss_sold_time_sk
    ...
    shuffle3_cfg(23, 16) = 2; // ss_sold_time_sk
    ...
    shuffle4_cfg(23, 16) = 2; // ss_sold_time_sk
...
void get_cfg_dat_JOIN_INNER_TD_6131820_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(23, 16) = 8; // cs_sold_time_sk
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // cs_sold_time_sk
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // cs_sold_time_sk
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6489857_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // ws_ext_sales_price
    shuffle2_cfg(15, 8) = 6; // ws_item_sk
    shuffle2_cfg(23, 16) = 8; // ws_sold_time_sk
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // ws_sold_time_sk
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // ws_sold_time_sk
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
