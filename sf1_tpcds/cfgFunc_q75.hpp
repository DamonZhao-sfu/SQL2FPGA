...
void get_cfg_dat_Aggregate_TD_6385216_gqe_aggr(ap_uint<32>* buf) {
...
void get_cfg_dat_Aggregate_TD_6554757_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
...
void get_cfg_dat_Aggregate_TD_5334057_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
...
void get_cfg_dat_Aggregate_TD_561353_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
