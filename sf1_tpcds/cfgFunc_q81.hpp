...
void get_cfg_dat_JOIN_INNER_TD_10451888_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // cr_returning_customer_sk
    shuffle2_cfg(15, 8) = 6; // cr_returning_addr_sk
    shuffle2_cfg(23, 16) = 8; // cr_return_amt_inc_tax
    ...
    shuffle3_cfg(7, 0) = 0; // cr_returning_customer_sk
    shuffle3_cfg(15, 8) = 1; // cr_returning_addr_sk
    shuffle3_cfg(23, 16) = 2; // cr_return_amt_inc_tax
    ...
    shuffle4_cfg(7, 0) = 0; // cr_returning_customer_sk
    shuffle4_cfg(15, 8) = 1; // cr_returning_addr_sk
    shuffle4_cfg(23, 16) = 2; // cr_return_amt_inc_tax
...
void get_cfg_dat_JOIN_INNER_TD_9269164_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((cr_returned_date_sk#1023 = d_date_sk#120))
    // Left Table: ListBuffer(cr_returned_date_sk#1023, cr_returning_customer_sk#1030, cr_returning_addr_sk#1033, cr_return_amt_inc_tax#1043)
