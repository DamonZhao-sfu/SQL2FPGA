...
void get_cfg_dat_JOIN_INNER_TD_5925652_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 9; // wr_reason_sk
    shuffle2_cfg(23, 16) = 6; // wr_fee
    shuffle2_cfg(31, 24) = 8; // wr_refunded_cash
    ...
    shuffle3_cfg(15, 8) = 1; // wr_reason_sk
    shuffle3_cfg(23, 16) = 2; // wr_fee
    shuffle3_cfg(31, 24) = 3; // wr_refunded_cash
    ...
    shuffle4_cfg(15, 8) = 1; // wr_reason_sk
    shuffle4_cfg(23, 16) = 2; // wr_fee
    shuffle4_cfg(31, 24) = 3; // wr_refunded_cash
