...
class TpcdsSchemaProvider(sc: SparkSession, inputDir: String, format: String)
  ...
  dfMap = Map(
    "customer" -> sc.read
      ...
      .toDF(),
    "customer_address" -> sc.read
      .format(format)
      .load("file://" + inputDir + "/customer_address")
      .toDF(),
    "customer_demographics" -> sc.read
      .format(format)
    ...
    "date_dim" -> sc.read
      ...
      .toDF(),
    "household_demographics" -> sc.read
      .format(format)
    ...
    "call_center" -> sc.read
      ...
      .toDF(),
    "catalog_page" -> sc.read
      .format(format)
      .load("file://" + inputDir + "/catalog_page")
      .toDF(),
    "catalog_returns" -> sc.read
      .format(format)
      .load("file://" + inputDir + "/catalog_returns")
      .toDF(),
    "catalog_sales" -> sc.read
      .format(format)
      .load("file://" + inputDir + "/catalog_sales")
      .toDF(),
    "store_sales" -> sc.read
      .format(format)
      .load("file://" + inputDir + "/store_sales")
      .toDF()
  )
